defmodule PhxLiveSvelteFreWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxLiveSvelteFreWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxLiveSvelteFreWeb.Gettext, "errors", msg, opts)
    end
  end
